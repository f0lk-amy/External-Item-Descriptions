...
local repCollectibles={
	...
	[13] = {"13", "Virusul", "↑ {{Speed}} +0.2 Viteză#{{Poison}} La atingerea inamicilor ii otrăvești#Isac cauzează 48 daune de contact pe secundă"}, -- The Virus
	...
	[30] = {"30", "Tocurile Mamei", "↑ {{Range}} +2.5 Rază de atac#Isac cauzează 24 daune la contact pe secundă"}, -- Mom's Heels
	[31] = {"31", "Rujul Mamei", "↑ {{Range}} +3.75 Rază de atac#{{UnknownHeart}} Oferă 1 inimă aleatorie pe jos"}, -- Mom's Lipstick
	[37] = {"37", "Dl. Bum", "Aruncă o bombă mare dedesubt de Isac care cauzează 185 de daune"}, -- Mr. Boom
	...
	[52] = {"52", "Dl. Fetus", "↓ {{Tears}} x0.4 Viteză de Atac#{{Bomb}} Isac împușcă cu bombe în loc de lacrimi#{{Damage}} Aceste bombe cauzează 10x daunele lui Isac#Dacă asta rezultă în daune de peste 60, ele vor cauza 5x + 30"}, -- Dr. Fetus
	...
	[83] = {"83", "Cuiul", "La folosire:#{{HalfBlackHeart}} +1 jumătate de Inimă Neagră#{{Timer}} Primesti pe durata camerei:#↑ {{Damage}} +2 Daune#↓ {{Speed}} -0.18 Viteză#Isac cauzează 40 daune la contact pe secundă#Poți distruge pietrele trecând prin ele"}, -- The Nail
	...
	[206] = {"206", "Gilotină", "↑ {{Tears}} +0.5 Lacrimi#↑ {{Damage}} +1 Daună#Capul lui Isac devine un orbital care îmușcă, nu poate fi rănit și provoacă 56 de daune de contact pe secundă"}, -- Guillotine
	...
	[233] = {"233", "Planeta Micuță", "↑ {{Range}} +6.5 Rază de atac#Lacrimi speculare#Lacrimile lui Isac orbitează în jurul lui"}, -- Tiny Planet
	...
	[440] = {"440", "Piatră la Rinichi", "Ocazional Isac se oprește din tras și încarcă un atac care eliberează o furună de lacrimi și o piatră la rinichi#↑ {{Damage}} Piatra la rinchi provoacă 10x din daunele lui Isac și rază de atac dublă#↑ {{Tears}} Furtuna de lacrimi oferă 6x viteza lacrimilor"}, -- Kidney Stone
	...
	[531] = {"531", "Hemolacrie", "↑ {{Damage}} +1 Daune#↑ {{Damage}} x1.5 Daune#↓ {{Tears}} x0.33 Viteza lacrimilor#↓ {{Range}} x0.8 Rază de atac#Lacrimile lui Isac sunt aruncate arcuit și se sparg în lacrimi mai mici la impact"}, -- Haemolacria
	...
	[572] = {"572", "Ochiul Ocultului", "↑ {{Damage}} +1 Daune#↑ {{Range}} +2 Rază de atac#↓ {{Shotspeed}} -0.16 Viteza lacrimilor#Lacrimile lui Isac pot fi controlate în aer"}, -- Eye of the Occult
	...
	[625] = {"625", "Mega Ciupercă", "Isac devine uriaș și primește:#↑ {{Damage}} x4 Daune#↑ {{Range}} +2 Rază de atac#↓ {{Tears}} -1.9 Lacrimi#Invincibilitate#Isac poate zdrobi inamicii și obstacolele#{{Timer}} Durează 30 de secunde și persistă printre camere și etaje"}, -- Mega Mush
	...
	[636] = {"636", "R Key", "{{Warning}} UNICĂ FOLOSINȚĂ {{Warning}}#Restartează runul#Tot ce deține Isac este păstrat#Timpul nu se resetează"}, -- R Key
	...
	[644] = {"644", "Premiu de Consolare", "↑ Înlocuiește cea mai mică valoare a lui Isac dintre: Viteză, Viteză de atac, Daune, Rază de atac#Oferă 3 {{Coin}} bănuți, 1 {{Bomb}} bombă sau 1 {{Key}} cheie(depinde de ce are Isac nevoie mai mult)"}, -- Consolation Prize
	...
	[656] = {"656", "Damocles", "{{Warning}}#O sabie atârnă deasupra lui Isac care dublează toate piedestalele#Itemele care costa sau vin din chesturi nu sunt dublate#{{Warning}} După ce Isac este vătămat sabia are o șansă extrem de mică să îl omoare pe Isac la fiecare frame#Efectele de invincibilitate pot preveni acest efect"}, -- Damocles (hidden passive version)
...
local repCards={
	...
	[42] = {"42", "Cartea Chaos", "La folosire cartea este aruncată în direcția în care Isac se mișcă#Omoară TOȚI inamicii care o ating (cu excepție Delirium si Bestia)"}, -- Chaos Card
...
local repConditions = {
	...
	["Eye of the Occult Beam"] = "Isac automatically shoots with a crosshair that alters the beam's path",
