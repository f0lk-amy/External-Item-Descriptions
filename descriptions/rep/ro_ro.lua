...
local repCollectibles={
	...
	[280] = {"280", "Sissy Picioare-Lungi", "Oferă la întâmplare un păianjen albastru într-o cameră neterminată#{{Charm}} Inamici cu care intră în contact vor fi vrăjiți"}, -- Sissy Longlegs
...
EID.descriptions[languageCode].bookOfVirtuesWisps = {
	...
	[35] = "Musculițe de apropiere {{InnerWisp}}#3.5% chance for {{Fear}} fear tears#{{Collectible35}} Necronomicon effect when destroyed", -- The Necronomicon
	[36] = "Musculițe distanțate {{OuterWisp}}#2.5% chance for {{Collectible236}} E. Coli tears", -- The Poop
	[37] = "Musculițe de mijloc {{MiddleWisp}}#Drop scatter homing bombs when destroyed", -- Mr. Boom
	[38] = "Musculițe distanțate {{OuterWisp}}#Rapid, inaccurate tears", -- Tammy's Head
	[39] = "Musculițe de mijloc {{MiddleWisp}}#5% chance for petrifying tears", -- Mom's Bra
	[40] = "Musculițe de mijloc {{MiddleWisp}}#Explosive tears#Explodes when destroyed", -- Kamikaze!
	[41] = "Musculițe de mijloc {{MiddleWisp}}#7.5% chance for {{Fear}} fear tears", -- Mom's Pad
	[42] = "Musculițe de mijloc {{MiddleWisp}}#7.5% chance for {{Collectible149}} Ipecac tears", -- Bob's Rotten Head
	[44] = "Musculițe de mijloc {{MiddleWisp}}#10% chance for tears to teleport enemies#Wisps flicker every 5 seconds", -- Teleport!
	[45] = "Musculițe de mijloc {{MiddleWisp}}#20% chance for enemies to drop 1 {{Heart}} Red Heart on kill", -- Yum Heart
	[47] = "Musculițe de mijloc {{MiddleWisp}}#Shoot 3 explosive tears towards the crosshair on use", -- Doctor's Remote
	[49] = "Musculițe distanțate {{OuterWisp}}#Cannot shoot tears#Fires a beam on use", -- Shoop da Whoop!
