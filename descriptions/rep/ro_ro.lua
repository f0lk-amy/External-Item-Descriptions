...
local repCollectibles={
	...
	[5] = {"5", "Reflexia Mea", "↑ {{Damage}} +1.5 Daune#↑ {{Range}} x2 + 1.5 Rază de atac#↑ {{Shotspeed}} x1.6 Viteza lacrimilor#↓ {{Luck}} -1 Noroc#Lacrimile au un efect de bumerang"}, -- My Reflection
	[6] = {"6", "Numărul Unu", "↑ {{Tears}} +1.5 Lacrimi#↓ {{Range}} -1.5 Rază de atac#↓ {{Range}} x0.8 Rază de atac"}, -- Number One
	[12] = {"12", "Ciupercă Magică", "↑ {{Heart}} +1 Viață#↑ {{Speed}} +0.3 Viteză#↑ {{Damage}} +0.3 Daune#↑ {{Damage}} x1.5 Daune#↑ {{Range}} +2.5 Rază de atac#Crește mărimea#{{HealingRed}} Vindecă inimile"}, -- Magic Mushroom
	[13] = {"13", "Virusul", "↑ {{Speed}} +0.2 Viteză#{{Poison}} La atingerea inamicilor ii otrăvești#Isaac cauzează 48 daune de contact pe secundă"}, -- The Virus
	[14] = {"14", "Furie cu Steroizi", "↑ {{Speed}} +0.3 Viteză#↑ {{Range}} +2.5 Rază de atac"}, -- Roid Rage
	[18] = {"18", "Un Leu", "{{Coin}} +100 Bănuți"}, -- A Dollar
	[22] = {"22", "Prânz", "↑ {{Heart}} +1 Viață#{{HealingRed}} Vindecă o inimă"}, -- Lunch
	[23] = {"23", "Cină", "↑ {{Heart}} +1 Viață#{{HealingRed}} Vindecă o inimă"}, -- Dinner
	[24] = {"24", "Desert", "↑ {{Heart}} +1 Viață#{{HealingRed}} Vindecă o inimă"}, -- Dessert
	[25] = {"25", "Mic Dejun", "↑ {{Heart}} +1 Viață#{{HealingRed}} Vindecă o inimă"}, -- Breakfast
	[26] = {"26", "Carne Stricată", "↑ {{Heart}} +1 Viață#{{HealingRed}} Vindecă o inimă"}, -- Rotten Meat
	[29] = {"29", "Chiloții Mamei", "↑ {{Range}} +2.5 Rază de atac#Oferă 3-6 muște albastre"}, -- Mom's Underwear
	[30] = {"30", "Tocurile Mamei", "↑ {{Range}} +2.5 Rază de atac#Isaac cauzează 24 daune la contact pe secundă"}, -- Mom's Heels
	[31] = {"31", "Rujul Mamei", "↑ {{Range}} +3.75 Rază de atac#{{UnknownHeart}} Oferă 1 inimă aleatorie pe jos"}, -- Mom's Lipstick
	[37] = {"37", "Dl. Bum", "Aruncă o bombă mare dedesubt de Isaac care cauzează 185 de daune"}, -- Mr. Boom
	...
	[42] = {"42", "Capul putrezit a lui Bob", "La folosire și aruncare intr-o direcție îi aruncă capul#{{Poison}} La aterizare capul explodează și creează un nor otrăvitor#Cauzează daunele lui Isaac + 185"}, -- Bob's Rotten Head
	...
	[98] = {"98", "Relicva", "{{SoulHeart}} Oferă o Inima Suflet la fiecare 7-8 camere"}, -- The Relic
	...
	[149] = {"149", "Ipecac", "↑ {{Damage}} +40 Daune#↓ {{Tears}} x0.33 Viteză de atac#↓ {{Range}} x0.8 Rază de atac#↓ {{Shotspeed}} -0.2 Viteza lacrimilor#Lacrimile sunt aruncate arcuit{{Poison}} lacrimile explodează și otrăvesc inamicii în locul în care aterizează"}, -- Ipecac
	...
	[206] = {"206", "Gilotină", "↑ {{Tears}} +0.5 Lacrimi#↑ {{Damage}} +1 Daună#Capul lui Isaac devine un orbital care îmușcă, nu poate fi rănit și provoacă 56 de daune de contact pe secundă"}, -- Guillotine
	...
	[223] = {"223", "Piromaniac", "{{Bomb}} +5 Bombe# Imunitate la explozi și foc#{{HealingRed}} Exploziile te vindecă jumatate de inimă"}, -- Pyromaniac
	...
	[233] = {"233", "Planeta Micuță", "↑ {{Range}} +6.5 Rază de atac#Lacrimi speculare#Lacrimile lui Isaac orbitează în jurul lui"}, -- Tiny Planet
	...
	[272] = {"272", "CMBP", "Muscă prietenoasă care explodează #Explozia cauzează 100 de daune#{{Warning}} Explozia poate să îl răcească pe Isaac"}, -- BBF
	...
	[283] = {"283", "D100", "Dublează 1 pickup de pe jos#Schimbă aleatoriu viteza, lacrimile, daunele, raza de atac și itemele pasive a le lui Isaac#Schimbă toate piedestalele, pickupurile și pietrele din cameră#Reîncepe camera, învie toți inamicii și îi involuează"}, -- D100
	...
	[314] = {"314", "Coapse Grase", "↑ {{Heart}} +1 Viață#↓ {{Speed}} -0.4 Viteză#{{HealingRed}} Vindecă 1 inimă#Isaac poate să sparga pietrele daca trece prin ele"}, -- Thunder Thighs
	...
	[319] = {"319", "Celalat Ochi a lui Cain", "Aruncă lacrimi în direcții aleatorii cu același efecte a lui Isaac#{{Damage}} Provoacă 75% din daunele lui Isaac"}, -- Cain's Other Eye
	...
	[330] = {"330", "Lapte de Soia", "↑ {{Tears}} x5.5 Viteză de atac#↓ {{Damage}} x0.2 Daune#↓ {{Tearsize}} -0.3 Marimea Lacrimilor#Puterea lui Isaac de a arunca inamici în spate este scăzută semnificativ"}, -- Soy Milk
	...
	[440] = {"440", "Piatră la Rinichi", "Ocazional Isaac se oprește din tras și încarcă un atac care eliberează o furună de lacrimi și o piatră la rinichi#↑ {{Damage}} Piatra la rinchi provoacă 10x din daunele lui Isaac și rază de atac dublă#↑ {{Tears}} Furtuna de lacrimi oferă 6x viteza lacrimilor"}, -- Kidney Stone
	...
	[474] = {"474", "Tun de Sticlă Spart", "Dacă folosești itemul se transformă în  Glass Cannon"}, -- Broken Glass Cannon
	...
	[497] = {"497", "Chioți de Camunflat", "{{Confusion}} La intrarea într-o cameră Isaac este camunflat până trage cu o lacrimă#↑ {{Speed}} +0.5 viteză cand este camunflat#După tragerea unei Lacrimi Isaac provoacă daune în jurul lui, viteza lacrimilor și daunele sunt crescute temporar"}, -- Camo Undies
	...
	[523] = {"523", "Cutie de Mutat", "Poate ține până la 10 pickupuri și iteme din camera curentă#Dacă este folosită din nou tot ce a adunat va fi lăsat pe jos#Îi perimte lui Isaac să care lucuri dintr-o cameră în alta"}, -- Moving Box
	...
	[560] = {"560", "Doare", "{{Timer}} Dacă Isaac este vătămat primește pe durata camerei:#↑ {{Tears}} +1.2 Viteză de atac la prima lovitură#↑ {{Tears}} +0.4 Viteză de atac pentru alte lovituri#Eliberează un inel de 10 lacrimi în jurul lui Isaac"}, -- It Hurts
	...
	[562] = {"562", "La Pământ", "↑ Previne ca valorile lui Isaac să fie scăzute pe durata runului#Statisticile negative o să fie în continuare calculate, dar Isaac nu o să fie afectat de ele"}, -- Rock Bottom
	...
	[572] = {"572", "Ochiul Ocultului", "↑ {{Damage}} +1 Daune#↑ {{Range}} +2 Rază de atac#↓ {{Shotspeed}} -0.16 Viteza lacrimilor#Lacrimile lui Isaac pot fi controlate în aer"}, -- Eye of the Occult
	[573] = {"573", "Inimă Imaculată", "↑ {{Heart}} +1 Viață#↑ {{Damage}} x1.2 Daune#{{HealingRed}} Vindecă Inimile Roșii#20% șansă să arunci cu o lacrimă spectrală extra care orbitează"}, -- Immaculate Heart
	...
	[635] = {"635", "Copcii", "Oferă un familiar care se deplasează în direcția în care Isaac trage#Cînd este folosit Isaac schimbă poziția cu familiarul și devine pentru un moment invincibil#Teleportarea pe obiecte cauzează ca ele să fie distuse sau vătămate"}, -- Stitches
...
EID.descriptions[languageCode].bookOfVirtuesWisps = {
	...
	[49] = "Musculițe distanțate {{OuterWisp}}#Nu poate trage cu lacrimi#Trage cu o rază la folosire", -- Shoop da Whoop!
	[56] = "Musculițe de mijloc {{MiddleWisp}}#Rapid, low range tears#Wisp drips yellow creep", -- Lemon Mishap
	[58] = "Musculițe de mijloc {{MiddleWisp}}#Low HP but immune to projectiles#Immune to damage during {{Collectible58}} effect", -- Book of Shadows
	[65] = "Musculițe de mijloc {{MiddleWisp}}#Drop a Troll Bomb when destroyed", -- Anarchist Cookbook
	[66] = "Musculițe de mijloc {{MiddleWisp}}#{{Slow}} Slows enemies for 3 seconds when destroyed", -- The Hourglass
	[77] = "Musculițe de mijloc {{MiddleWisp}}#Extra contact damage", -- My Little Unicorn
	[78] = "Musculițe de apropiere {{InnerWisp}}#Cannot shoot tears#Spawns a Locust for the room when destroyed", -- Book of Revelations
	[83] = "Musculițe de apropiere {{InnerWisp}}#Double damage and knockback tears", -- The Nail
	[84] = "Musculițe de mijloc {{MiddleWisp}}#No special effect", -- We Need to Go Deeper!
	[85] = "Musculițe de apropiere {{InnerWisp}}#Drop a {{Card}} card when destroyed", -- Deck of Cards
	[86] = "Musculițe de mijloc {{MiddleWisp}}#Tooth tears", -- Monstro's Tooth
	[93] = "Musculițe de apropiere {{InnerWisp}}#Anti-gravity tears#Chance for {{Fear}} fear tears", -- The Gamekid
	...
	[102] = "Musculițe de apropiere {{InnerWisp}}#Spawns 1 of 6 wisps:#normal tears that spawns an enemy spider when destroyed or chance for poison, petrify, confusion, burn, Troll Bomb tears#All 6 spawn a {{Pill}} pill when destroyed", -- Mom's Bottle of Pills
	[105] = "Musculițe de mijloc {{MiddleWisp}}#+1 Wisp per item rerolled", -- The D6
	[107] = "Musculițe de apropiere {{InnerWisp}}#Piercing tears", -- The Pinking Shears
	[111] = "Musculițe distanțate {{OuterWisp}}#{{Poison}} Poison fart when destroyed", -- The Bean
	[123] = "Musculițe de apropiere {{InnerWisp}}#Random tears", -- Monster Manual
	[124] = "Spawns the wisp of what item it mimics", -- Dead Sea Scrolls
	[126] = "Musculițe de mijloc {{MiddleWisp}}#High HP wisps", -- Razor Blade
	[127] = "Musculițe de mijloc {{MiddleWisp}}#Infinite HP wisp for the new floor", -- Forget Me Now
	[130] = "Musculițe de mijloc {{MiddleWisp}}#Cannot shoot tears#Wisps charge în the direction Isaac shoots", -- A Pony
	[133] = "Musculițe de mijloc {{MiddleWisp}}#Spawns 3 high HP wisps", -- Guppy's Paw
	[135] = "Musculițe distanțate {{OuterWisp}}#Low HP wisp", -- IV Bag
	[136] = "Musculițe de mijloc {{MiddleWisp}}#7.5% chance for {{Bait}} mark tears#Marked enemies are attacked by other enemies", -- Best Friend
	[137] = "Musculițe de apropiere {{InnerWisp}}#+1 Wisp per bomb detonated#Wisp's tears can also be remote detonated", -- Remote Detonator
	[145] = "Musculițe distanțate {{OuterWisp}}#Wisps are spawned instead of flies#Spawns a blue fly when destroyed", -- Guppy's Head
	[146] = "Musculițe de apropiere {{InnerWisp}}#Homing tears", -- Prayer Card
	...
	[158] = "Musculițe de mijloc {{MiddleWisp}}#High HP wisp that shoots at nearby enemies", -- Crystal Ball
	[160] = "Musculițe de mijloc {{MiddleWisp}}#Summon a beam of light on contact", -- Crack the Sky
	[164] = "Musculițe de mijloc {{MiddleWisp}}#Single room wisp", -- The Candle
	[166] = "Musculițe de mijloc {{MiddleWisp}}#Destroys all pickups în the room, with a chance to spawn a random wisp for each", -- D20
	[171] = "Musculițe de mijloc {{MiddleWisp}}#7.5% chance for {{Slow}} slow tears", -- Spider Butt
	[175] = "Musculițe de mijloc {{MiddleWisp}}#Wisps open locked chests/doors on touch, including the Mega Satan, Ascent, and Corpse doors#Wisps donate themselves to {{KeyBeggar}} Key Masters", -- Dad's Key
	[177] = "Spawns a wisp based on the reward won", -- Portable Slot
	[181] = "Musculițe de mijloc {{MiddleWisp}}#10% chance for {{Collectible374}} Holy Light tears", -- White Pony
	[186] = "Musculițe de mijloc {{MiddleWisp}}#High HP wisp", -- Blood Rights
	[192] = "Musculițe de mijloc {{MiddleWisp}}#Homing tears", -- Telepathy for Dummies
	[263] = "Musculițe de mijloc {{MiddleWisp}}#15% chance for enemies to drop a {{Rune}} rune on kill#Drops a {{Rune}} rune when destroyed", -- Clear Rune
	...
	[285] = "Musculițe de mijloc {{MiddleWisp}}#10% chance for D10 effect tears", -- D10
	[286] = "Musculițe de mijloc {{MiddleWisp}}#15% chance for enemies to drop a {{Card}} card on kill#Spawns a {{Card}} card when destroyed", -- Blank Card
	[287] = "Musculițe de mijloc {{MiddleWisp}}#{{Collectible675}} Cracked Orb effect when destroyed", -- Book of Secrets
	[288] = "Musculițe distanțate {{OuterWisp}}#Wisps are spawned instead of spiders#Spawns a blue spider when destroyed", -- Box of Spiders
	[289] = "Musculițe de mijloc {{MiddleWisp}}#Single room wisp#Red flame tears", -- Red Candle
	[290] = "Musculițe de mijloc {{MiddleWisp}}#Creates a wisp per heart instead of dropping them as pickups#Chance to spawn a {{HalfHeart}} half Red Heart when destroyed", -- The Jar
	[291] = "Musculițe de mijloc {{MiddleWisp}}#Spawns an extra wisp per flushed enemy", -- Flush!
	[292] = "Musculițe de mijloc {{MiddleWisp}}#+10% {{AngelDevilChance}} Devil/Angel Room chance per Satanic Bible wisp", -- Satanic Bible
	[293] = "Musculițe de mijloc {{MiddleWisp}}#Fires a 4-way {{Collectible118}} Brimstone beam when destroyed", -- Head of Krampus
	[294] = "Musculițe de apropiere {{InnerWisp}}#Low HP single room wisp#Cannot shoot tears#Butter Bean effect when destroyed", -- Butter Bean
	[295] = "Musculițe de apropiere {{InnerWisp}}#Chance to drop a {{Coin}} coin when destroyed", -- Magic Fingers
	[296] = "Musculițe de mijloc {{MiddleWisp}}#Higher HP wisp that can be healed with {{Heart}} Red Hearts", -- Converter
	[297] = "Musculițe de mijloc {{MiddleWisp}}#Spawns 0-8 wisps depending on the floor", -- Pandora's Box
	[298] = "Musculițe de mijloc {{MiddleWisp}}#Cannot shoot tears#Immune to contact damage#Doesn't deal contact damage unless Unicorn Stump or a similar effect is active", -- Unicorn Stump
	[323] = "Musculițe de mijloc {{MiddleWisp}}#Spawns 6 wisps#3 Second lifetime", -- Isaac's Tears
	[324] = "Musculițe de mijloc {{MiddleWisp}}#{{Collectible570}} Playdough Cookie tears", -- Undefined
	[325] = "Musculițe de mijloc {{MiddleWisp}}#Arcing cluster tears", -- Scissors
	[326] = "Musculițe de apropiere {{InnerWisp}}#Spawns 4 wisps on a perfect block", -- Breath of Life
	[338] = "Musculițe de mijloc {{MiddleWisp}}#Single room wisp#Boomerang tears", -- The Boomerang
	[347] = "Musculițe de mijloc {{MiddleWisp}}#High HP wisps with {{Collectible245}} 20/20 tears#Duplicate all other wisps", -- Diplopia
	[348] = "Musculițe de mijloc {{MiddleWisp}}#Spawns a {{Pill}} pill when destroyed", -- Placebo
	[349] = "Musculițe de mijloc {{MiddleWisp}}#50% chance to drop a {{Coin}} coin when destroyed", -- Wooden Nickel
	[351] = "Musculițe de mijloc {{MiddleWisp}}#Send a rock wave out on use#Petrify + {{Poison}} poison fart when destroyed", -- Mega Bean
	[352] = "Musculițe de mijloc {{MiddleWisp}}#Low HP wisp that persists between rooms#All Glass Cannon wisps are destroyed when one is destroyed", -- Glass Cannon
	[357] = "Musculițe de mijloc {{MiddleWisp}}#No special effect#Duplicate all wisps for the room", -- Box of Friends
	...
	[383] = "Musculițe de mijloc {{MiddleWisp}}#Wisp's tears can be detonated, turning into 6 of Isaac's tears#Persists between rooms#Burst into Isaac's tears when destroyed", -- Tear Detonator
	[386] = "Musculițe de mijloc {{MiddleWisp}}#5% chance for tears to reroll rocks, urns, skulls or mushrooms", -- D12
	[396] = "Cannot shoot tears#Each portal has 1 wisp", -- Ventricle Razor
	[406] = "Musculițe de mijloc {{MiddleWisp}}#Random damage and fire rate", -- D8
	[419] = "Musculițe de mijloc {{MiddleWisp}}#20% chance for tears to teleport enemies#Wisps flicker every 5 seconds", -- Teleport 2.0
	[421] = "Musculițe de mijloc {{MiddleWisp}}#{{Charm}} Charm tears#{{Charm}} Charm fart when destroyed", -- Kidney Bean
	[422] = "Musculițe de mijloc {{MiddleWisp}}#30% chance for petrifying tears#Respawns all wisps that got destroyed în the previous room", -- Glowing Hourglass
	[427] = "Bounces around the room, exploding when shot by Isaac#Cannot shoot tears or deal contact damage", -- Mine Crafter
	[434] = "Musculițe de mijloc {{MiddleWisp}}#Wisps are spawned instead of flies#Up to 5 flies makes 1 wisp with increased health and damage", -- Jar of Flies
	[437] = "Musculițe de mijloc {{MiddleWisp}}#D7 effect when hit for the first time", -- D7
	[439] = "Musculițe de mijloc {{MiddleWisp}}#No special effect", -- Mom's Box
	[441] = "Musculițe de mijloc {{MiddleWisp}}#{{Chargeable}} Chargeable Brimstone tears#Shoot continuously during a Mega Blast", -- Mega Blast
	[475] = "Musculițe de mijloc {{MiddleWisp}}#Spawns 8 high damage wisps that stay after death", -- Plan C
	[476] = "Musculițe de mijloc {{MiddleWisp}}#Spawns a second wisp if no pickup was duplicated", -- D1
	[477] = "Spawns the wisps of all absorbed active items#Doesn't spawn a wisp itself", -- Void
	[478] = "Musculițe de mijloc {{MiddleWisp}}#Pauses all enemies and shots for 3 seconds when destroyed", -- Pause
	[479] = "Musculițe de mijloc {{MiddleWisp}}#Chance to spawn a {{Trinket}} trinket when destroyed", -- Smelter
	[480] = "Musculițe de mijloc {{MiddleWisp}}#Increased HP for each pickup converted#Only spawns a wisp if at least one pickup got converted", -- Compost
	[481] = "Musculițe de mijloc {{MiddleWisp}}#5% chance for tears to transform enemies into random wisps", -- Dataminer
	[482] = "Spawns a random wisp", -- Clicker
	[483] = "Musculițe de mijloc {{MiddleWisp}}#Spawns 8 wisps that drop a golden Troll Bomb when destroyed", -- Mama Mega!
	[484] = "Musculițe de mijloc {{MiddleWisp}}#Single room wisp#Cannot shoot tears#Wait What? effect when destroyed", -- Wait What?
	[485] = "Musculițe de mijloc {{MiddleWisp}}#All Crooked Penny wisps are destroyed or duplicated when one is damaged", -- Crooked Penny
	[486] = "Musculițe de mijloc {{MiddleWisp}}#Cannot shoot tears#Chance to negate Isaac taking damage and get destroyed for it", -- Dull Razor
	...
	[489] = "Musculițe de mijloc {{MiddleWisp}}#Spawns a normal wisp#Extra effect based on the mimicked die", -- D Infinity
	[490] = "Spawns a random wisp#Respawns after clearing a room if destroyed", -- Eden's Soul
	[504] = "Musculițe de mijloc {{MiddleWisp}}#Single room wisp#Rapid, low damage, aimed tears", -- Brown Nugget
	[507] = "Musculițe distanțate {{OuterWisp}}#Chance to spawn a wisp on kill", -- Sharp Straw
	[510] = "Musculițe de mijloc {{MiddleWisp}}#{{Collectible229}} Monstro's Lung, {{Collectible268}} Rotten Baby, {{Collectible87}} Loki's Horns or {{Collectible118}} Brimstone tears", -- Delirious
	[512] = "Musculițe de mijloc {{MiddleWisp}}#Magnetic tears", -- Black Hole
	[515] = "Spawns a random wisp#Respawns after clearing a room if destroyed", -- Mystery Gift
	[516] = "Musculițe de mijloc {{MiddleWisp}}#Rapid tears#Tears shoot în 8 directions like Sprinkler", -- Sprinkler
	[521] = "Musculițe de mijloc {{MiddleWisp}}#Triple shot#Purchasing anything destroys all Coupon wisps", -- Coupon
	[522] = "Musculițe distanțate {{OuterWisp}}#Captured projectiles turn into wisps", -- Telekinesis
	[523] = "Musculițe de mijloc {{MiddleWisp}}#Wisp only spawns when dropping items#Spawns a random pickup when destroyed", -- Moving Box
	[527] = "Musculițe de mijloc {{MiddleWisp}}#Cannot shoot tears#On room clear, wisps open chests/doors", -- Mr. ME!
	[536] = "Musculițe de mijloc {{MiddleWisp}}#Converts all wisps into {{HalfHeart}} half Red Hearts#Spawns a high HP, high damage wisp on sacrifice", -- Sacrificial Altar
	[545] = "Musculițe de apropiere {{InnerWisp}}#Spawns a friendly Bony when destroyed", -- Book of the Dead
	[550] = "Musculițe de mijloc {{MiddleWisp}}#10% chance for tears to make Mom stomp on the enemy", -- Broken Shovel
	[552] = "Musculițe de mijloc {{MiddleWisp}}#10% chance for tears to make Mom stomp on the enemy#Also spawns a high HP wisp that cannot shoot tears", -- Mom's Shovel
	[555] = "Musculițe de mijloc {{MiddleWisp}}#15% chance for {{Collectible202}} Midas' Touch tears", -- Golden Razor
	[556] = "Musculițe de mijloc {{MiddleWisp}}#Short range {{Collectible118}} Brimstone tears", -- Sulfur
	[557] = "Musculițe de mijloc {{MiddleWisp}}#↑ {{Luck}} +0.2 Luck per Fortune Cookie wisp", -- Fortune Cookie
	[577] = "Musculițe de mijloc {{MiddleWisp}}#No special effect", -- Damocles
	[578] = "Musculițe de mijloc {{MiddleWisp}}#Wisp drips yellow creep", -- Free Lemonade
	[580] = "Musculițe de mijloc {{MiddleWisp}}#Chance to create Red Doors when entering a new room", -- Red Key
	[582] = "Musculițe de mijloc {{MiddleWisp}}#Low damage tears#Max 1 Wavy Cap wisp", -- Wavy Cap
	[584] = "No benefit from multiple copies", -- Book of Virtues
	[585] = "Musculițe de mijloc {{MiddleWisp}}#Spawns 8 normal wisps", -- Alabaster Box
	...
	[605] = "Musculițe de mijloc {{MiddleWisp}}#No special effect", -- The Scooper
	[609] = "Musculițe de mijloc {{MiddleWisp}}#Only 50% to spawn an invincible wisp#50% chance for all Eternal D6 wisps to be destroyed on use", -- Eternal D6
	[611] = "Musculițe de mijloc {{MiddleWisp}}#Health and damage increases based on charges", -- Larynx
	[622] = "Musculițe de mijloc {{MiddleWisp}}#Replaces all wisps with 3 normal wisps", -- Genesis
	[623] = "Musculițe de mijloc {{MiddleWisp}}#No special effect", -- Sharp Key
	[631] = "Musculițe de mijloc {{MiddleWisp}}#Splits all wisps în half (halfs damage)#Wisps are destroyed if split a third time", -- Meat Cleaver
	[635] = "Single room wisp#Spawns a stationary wisp at Isaac's position before getting teleported (up to 6 wisps)", -- Stitches
	[636] = "No wisp", -- R Key
	[638] = "Musculițe de mijloc {{MiddleWisp}}#Immune to projectiles#Erases non-boss enemies on contact", -- Eraser
	[639] = "Musculițe de mijloc {{MiddleWisp}}#Spawns blue flies instead of shooting tears", -- Yuck Heart
	[640] = "Musculițe de mijloc {{MiddleWisp}}#Chance for blue flame tears", -- Urn of Souls
	[642] = "Musculițe de mijloc {{MiddleWisp}}#Poison tears", -- Magic Skin
	[650] = "Musculițe de mijloc {{MiddleWisp}}#When Baby Plum bounces diagonally, all Plum Flute wisps are invincible and do so as well", -- Plum Flute
	[653] = "No wisps#Red ghosts can shoot tears", -- Vade Retro
	[655] = "Musculițe de mijloc {{MiddleWisp}}#Temporary wisps during use#Rapid tears", -- Spin to Win
	[685] = "Triples the spawned wisps", -- Jar of Wisps
	[687] = "Spawns a random wisp", -- Friend Finder
	[703] = "Musculițe de mijloc {{MiddleWisp}}#No special effect", -- Esau Jr.
	[704] = "Musculițe de mijloc {{MiddleWisp}}#High HP wisp#Cannot shoot tears", -- Berserk!
	[705] = "Musculițe de mijloc {{MiddleWisp}}#Single room wisp per enemy killed", -- Dark Arts
	[706] = "Musculițe de mijloc {{MiddleWisp}}#High HP wisp#Cannot shoot tears", -- Abyss
	[709] = "Single room wisp#Spawns 3 wisps where Isaac lands", -- Suplex!
	[710] = "Spawns a random wisp on craft", -- Bag of Crafting
	[711] = "Musculițe de mijloc {{MiddleWisp}}#High HP wisp", -- Flip
	[712] = "The item wisps shoot homing tears", -- Lemegeton
	[713] = "No wisp", -- Sumptorium
	[719] = "Musculițe de mijloc {{MiddleWisp}}#20% chance for enemies to drop a {{Coin}} coin on kill", -- Keeper's Box
	...
	[723] = "Musculițe de mijloc {{MiddleWisp}}#Spawns a random wisp and rerolls all wisps into the type", -- Spindown Dice
	[728] = "Musculițe de mijloc {{MiddleWisp}}#All wisps orbit Gello while active", -- Gello
...
local repCarBattery = {
	...
	[635] = "Pozițile se schimbă de două ori#Bun pentru teleportat în inamici, dar nu poate colecta itemele la care Isaac nu poate ajunge", -- Stitches
...
local repBFFSSynergies = {
	...
	["5.100.276"] = "Fires additional shots în random directions and leaves a larger puddle of creep", -- Isaac's Heart
...
local repTrinkets={
	...
	[67] = {"67", "Zar Spart", "50% șansă să activeze unul din efectele urmatoare dacă Isaac este vătămat:#{{Collectible105}} D6#{{Collectible406}} D8#{{Collectible285}} D10#{{Collectible386}} D12#{{Collectible166}} D20"}, -- Cracked Dice
	...
	[98] = {"98", "Muci de Goblin", "10% șansă să arunci cu muci#50% șă fie balistică#{{Damage}} Mucii provoacă pagubele lui Isaac o dată pe secundă#Mucii stau lipiți 10 secunde"}, -- Nose Goblin
	...
	[152] = {"152", "Telescope Lens", "{{PlanetariumChance}} +9% Planetarium chance#Additional +15% chance if a Planetarium hasn't been entered yet#Planetariums can spawn în the Womb and Corpse"}, -- Telescope Lens
	...
	[155] = {"155", "Holy Crown", "Spawns a {{TreasureRoom}} Treasure Room and {{Shop}} Shop în Cathedral"}, -- Holy Crown
	...
	[161] = {"161", "Wicked Crown", "Spawns a {{TreasureRoom}} Treasure Room and {{Shop}} Shop în Sheol"}, -- Wicked Crown
	...
	[170] = {"170", "Crystal Key", "{{Collectible580}} Clearing a room has a 33% chance to create a Red Key room#Lower chance to occur when în a red room"}, -- Crystal Key
	...
	[174] = {"174", "Number Magnet", "{{DevilChance}} +10% Devil Room chance#Prevents Krampus from appearing în Devil Rooms#Devil Rooms are special variants with more deals, Black Hearts and enemies"}, -- Number Magnet
	...
	[179] = {"179", "RC Remote", "Familiars mimic Isaac's movement#Hold the drop button ({{ButtonRT}}) to keep the familiars în place"}, -- RC Remote
	[180] = {"180", "Found Soul", "Follows Isaac's movement and shoots spectral tears#Copies Isaac's stats, tear effects and 50% of his damage#Uses most active items when Isaac does#Dies în one hit#Respawns each floor"}, -- Found Soul
	...
	[187] = {"187", "Broken Glasses", "{{TreasureRoom}} 50% chance of adding an extra blind item în Treasure Rooms#50% chance to reveal the blind item în alt path Treasure Rooms"}, -- Broken Glasses
...
EID.descriptions[languageCode].goldenTrinketEffects = {
	...
	[25] = { "poop", "golden poop" },
	-- Isaac's Fork (find+replace): find Phrase #1 în the localized description, change it to Phrase #2 or 3 for doubled/tripled
...
local repCards={
	...
	[42] = {"42", "Chaos Card", "Using the card throws it în the direction Isaac is moving#Instantly kills ANY enemy it touches (except Delirium or the Beast)"}, -- Chaos Card
	...
	[81] = {"81", "Soul of Isaac", "Makes all item pedestals în the room cycle between two different items"}, -- Soul of Isaac
...
local repPills={
	...
	[42] = {"41", "I'm Drowsy...", "{{Slow}} Slows Isaac and all enemies în the room"}, -- I'm Drowsy...
	[43] = {"42", "I'm Excited!!", "{{Timer}} Speeds up Isaac and all enemies în the room#Triggers again after 30 and 60 seconds"}, -- I'm Excited!!
...
EID.descriptions[languageCode].horsepills={
	...
	{"36", "Power Pill!", "{{Timer}} Receive for the room:#↑ {{Damage}} +7 Damage#↑ {{Range}} +3 Range#{{Timer}} Receive for 6.5 seconds:#Invincibility#Isaac can't shoot but deals 40 contact damage per second#{{HealingRed}} Eating 2 enemies heals half a heart#{{Fear}} Fears all enemies în the room"}, -- Power Pill!
	...
	{"41", "I'm Drowsy...", "{{Slow}} Slows Isaac and all enemies în the room"}, -- I'm Drowsy...
	{"42", "I'm Excited!!", "Speeds up Isaac and all enemies în the room#Triggers again after 30 and 60 seconds"}, --I'm Excited!!
	...
	{"45", "Feels like I'm walking on sunshine!", "{{Timer}} Receive for 6.5 seconds:#Invincibility#Isaac can't shoot but deals 40 contact damage per second#{{HealingRed}} Eating 2 enemies heals half a heart#{{Fear}} Fears all enemies în the room"}, -- Feels like I'm walking on sunshine!
...
local repConditions = {
	...
	["5.100.358 (Copies)"] = "Isaac fires 1 more tear în the center", -- The Wiz
