...
local repCollectibles={
	...
	[83] = {"83", "Cuiul", "La folosire:#{{HalfBlackHeart}} +1 jumătate de Inimă Neagră#{{Timer}} Primesti pe durata camerei:#↑ {{Damage}} +2 Daune#↓ {{Speed}} -0.18 Viteză#Isaac cauzează 40 daune la contact pe secundă#Poți distruge pietrele trecând prin ele"}, -- The Nail
...
local repCards={
	...
	[42] = {"42", "Cartea Chaos", "La folosire cartea este aruncată în direcția în care Isaac se mișcă#Omoară TOȚI inamicii care o ating (cu excepție Delirium si Bestia)"}, -- Chaos Card
