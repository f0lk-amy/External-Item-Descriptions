...
local repCollectibles={
	...
	[12] = {"12", "Ciupercă Magică", "↑ {{Heart}} +1 Inimă#↑ {{Speed}} +0.3 Viteză#↑ {{Damage}} +0.3 Daune#↑ {{Damage}} x1.5 Daune#↑ {{Range}} +2.5 Rază de atac#Crește mărimea#{{HealingRed}} Vindecă inimile"}, -- Magic Mushroom
	...
	[42] = {"42", "Capul putrezit a lui Bob", "Capul este aruncat la folosire#{{Poison}} La aterizare capul explodează și creează un nor otrăvitor#Cauzează daunele lui Isaac + 185"}, -- Bob's Rotten Head
	...
	[101] = {"101", "Aureola", "↑ {{Heart}} +1 Inimă#↑ {{Speed}} +0.3 Viteză#↑ {{Tears}} +0.2 Lacrimi#↑ {{Damage}} +0.3 Daune#↑ {{Range}} +1.5 Rază de atac#{{HealingRed}} Vindecă o inimă"}, -- The Halo
	...
	[121] = {"121", "Ciupercă Ciudată(Mare)" , "↑ {{Heart}} +1 Inimă#↑ {{Damage}} +1 Daune#↑ {{Range}} +1.5 Rază de atac#↓ {{Speed}} -0.2 Viteză"}, -- Odd Mushroom (Large)
	...
	[307] = {"307", "Capricorn", "↑ {{Heart}} +1 Inimă#↑ {{Speed}} +0.1 Viteză#↑ {{Tears}} +0.5 Lacrimi#↑ {{Damage}} +0.5 Daune#↑ {{Range}} +0.75 Rază de atac#+1 {{Coin}} Monede, {{Bomb}} bombe și {{Key}} chiei#{{HealingRed}} Vindecă o inimă"}, -- Capricorn
	...
	[614] = {"614", "Bombe cu Sânge", "↑ {{Heart}} +1 Inimă#{{HealingRed}} Vindecă 4 Inimi Roșii#{{HalfHeart}} Dacă Isaac nu are bombe, o bombă poate fi pusă, dar costă o jumătate de inimă#Bombele lui Isaac lasă o baltă roșie#"}, -- Blood Bombs
...
[661] = {"661", "Cvadrupleți", "Când ucizi un inamic în locul lui apare un familiar staționar#Maxim 5 familiari"}, -- Quints
	...
	[669] = {"669", "Cârnat", "↑ {{Heart}} +1 Inimă#↑ {{Speed}} +0.2 Viteză#↑ {{Tears}} +0.5 Lacrimi#↑ {{Damage}} +0.5 Daune#↑ {{Range}} +2.5 Rază de atac#↑ {{Shotspeed}} +0.16 Viteza lacrimilor#↑ {{Luck}} +1 Noroc#{{HealingRed}} Vindecă inimile#↑ {{AngelDevilChance}} +6.9% Șansă la Camerele Înger/Diavol#↑ {{PlanetariumChance}} +6.9% Șansă la Planetariu"}, -- Sausage
...
EID.descriptions[languageCode].bookOfVirtuesWisps = {
	...
	[383] = "Musculițe de mijloc {{MiddleWisp}}#Lacrimile musculițelor pot fi detonate și se transformă in 6 lacrimi a le lui Isac#Persistă între camere#Explodează în lacrimile lui Isaac când este distrusă", -- Tear Detonator
