...
local repCollectibles={
	...
	[224] = {"224", "Corpul lui Cricket", "↑ {{Tears}} +0.5 Viteză de atac#↓ {{Range}} x0.8 Rază de atac#Lacrimile se împart în 4 la contact#Lacrimile împărțite cauzează jumătate din daune"}, -- Cricket's Body
	...
	[369] = {"369", "Continuul", "↑ {{Range}} +3 Rază de atac#Lacrimi spectrale#Lacrimile pot trece printr-o parte a ecranului și pot ieși pe cealaltă parte"}, -- Continuum
