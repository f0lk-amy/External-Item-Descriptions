...
local repTrinkets={
	...
	[157] = {"157", "Carte Ruptă", "La fiecare 15 lacrimi Isaac aruncă o lacrimă {{Collectible149}} Ipecac + {{Collectible5}} Reflecția Mea cu rază de atac mare"}, -- Torn Card
	...
	[167] = {"167", "Os Polișat", "Clearing a room has a 25% chance to spawn a friendly Bony"}, -- Polished Bone
