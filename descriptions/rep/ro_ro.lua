...
local repCollectibles={
	...
	[83] = {"83", "Cuiul", "La folosire:#{{HalfBlackHeart}} {{ColorGreen}}+1{{CR}} jumătate de Inimă Neagră#{{Timer}} Primești pe durata camerei:#↑ {{Damage}} {{ColorGreen}}+2{{CR}} Daune#↓ {{Speed}} {{ColorRed}}-0.18{{CR}} Viteză#Isac provoacă 40 dăune la contact pe secundă#Poți distruge pietrele trecând prin ele"}, -- The Nail
	...
	[404] = {"404", "Bebeluș Pârțâit", "Blochează proiectilele#Șansă de 10% să se bășească și să {{Charm}} vrăjească, {{Poison}} otrăvească sau să împingă inamicii#Beșina provoacă între 5-6 daune"}, -- Farting Baby
	...
	[495] = {"495", "Ardei Fantomă", "{{ColorGreen}}8%{{CR}} șansă să arunci cu un foc albastru care blochează proiectilele și cauzează daune inamicilor#{{Luck}} 50% șansă la 10 noroc#Focul se micește și dispare după 2 secunde"}, -- Ghost Pepper
	[496] = {"496", "Eutanasiere", "{{ColorGreen}}3.33%{{CR}} șansă să arunci cu un ac#{{Luck}} 25% șansă la 13 noroc#Acul omoară inamicii normali instant și arună 10 lacrimi când sunt eliminați#{{Damage}} Acul provoacă {{ColorGreen}}3x{{CR}} din daunele lui Isac împotriva șefilor"}, -- Euthanasia
	...
	[503] = {"503", "Coarnele Mici", "{{ColorGreen}}5%{{CR}} șansă să arunci cu o lacrimă care aduce mâna lui Big Horn#{{Luck}} 20% șansă la 15 noroc#Mâna omoară inamicii instant și provoacă 36 de daune șefilor#Isac provoacă 7 daune de contact pe secundă"}, -- Little Horn
	...
	[553] = {"553", "Mucormicoza", "{{ColorGreen}}25%{{CR}} șansă să arunci cu o lacrimă lipicioasă cu spori#{{Luck}} Șansa nu este afectată de noroc#{{Poison}} După 2.5 secunde sporii explodează, otravesc inamicii din jur și se răspândesc"}, -- Mucormycosis
	...
	[606] = {"606", "Ruptură oculară", "{{ColorGreen}}5%{{CR}} șansă să arunci cu o lacrimă care deschide o ruptură unde aterizează#{{Luck}} 20% șansă la 15 noroc#Ruptura cauzează {{ColorGreen}}3x{{CR}} daune pe secundă și atrage inamicii, pickupurile și proiectilele"}, -- Ocular Rift
	...
	[615] = {"615", "Micul Dumpy", "Deviază inamicii sau proiectilele chiar înainte ca Isaac să fie vătămat de acestea#{{ColorGreen}} șansă să devieze proiectilele apropiate de el#Trebuie atins pentru a se reactiva după ce a deviat un pericol"}, -- Lil Dumpy
	[616] = {"616", "Ochi de Pasăre", "{{ColorGreen}}8%{{CR}} Șansă să arunci cu un foc roșu care blochează proiectilele inamicilor și provoacă daune de contact#{{Luck}} 50% șansă la 10 noroc#Focul dispare după:  4 lovituri, provoacă daune de 4 ori sau dupa 10 secunde"}, -- Bird's Eye
	[617] = {"617", "Piatră Magnetică", "{{Magnetize}} {{ColorGreen}}17%{{CR}} șansă să tragi cu lacrimi magnetizate#{{Luck}} 100% șansă la 5 noroc#Inamicii magnetizați atrag: pickupuri proiectile și inamicii din apropiere"}, -- Lodestone
	[618] = {"618", "Roșie Stricată", "{{Bait}} {{ColorGreen}}17%{{CR}} șansă să arunci cu lacrimi care marchează inamicii#{{Luck}} 100% șansă la 5 noroc#Inamicii marcați sunt atacați de alți inamici"}, -- Rotten Tomato
	...
	[624] = {"624", "Pachet Suplimentar", "{{Card}} Oferă {{ColorGreen}}5{{CR}} cărți"}, -- Booster Pack
	...
	[628] = {"628", "Certificat de Deces", "{{Warning}} {{ColorRed}}O SINGURĂ FOLOSIRE{{CR}} {{Warning}}#Isaac este teleportat într-o care conține toate itemele din joc#Isaac poate alege doar un item și după este teleportat înapoi"}, -- Death Certificate
	...
	[636] = {"636", "Cheie R", "{{Warning}} {{ColorRed}}UNICĂ FOLOSINȚĂ{{CR}} {{Warning}}#Restartează runul#Tot ce deține Isac este păstrat#Timpul nu se resetează"}, -- R Key
	[637] = {"637", "Picături de Impact", "{{Confusion}} {{ColorGreen}}10%{{CR}} șansă să arunci cu un pumn care provoacă confuzie și împinge inamicii masiv#{{Luck}} 100% șansă la 9 noroc#Inamici primesc daune când sunt împinși în obstacole/zid"}, -- Knockout Drops
	...
	[663] = {"663", "Dinte și Unghii", "{{ColorGold}}1{{CR}} secundă de invincibilitate la fiecare {{ColorGreen}}6{{CR}} secunde#Isaac se aprinde intermitent înainte ca efectul să apară"}, -- Tooth and Nail
	...
	[670] = {"670", "Opțiuni?", "Isaac poate alege dintre {{ColorGreen}}2{{CR}} recomense la finalizarea camerei"}, -- Options?
	...
	[693] = {"693", "Roiul", "Primești {{ColorGreen}}8{{CR}} orbitali muște#Curățarea camerei oferă o muscă nouă#Muștele se transformă în muște albastre dacă sunt lovite"}, -- The Swarm
	...
	[706] = {"706", "Abyss", "Consumă toate itemele de pe piedestale și oferă o locustă pentru fiecare#Lăcustele provoacă daunele lui Isaac de {{ColorGreen}}2-3{{CR}} ori pe atac#Unele iteme oferă locuste speciale"}, -- Abyss
	...
	[713] = {"713", "Sumptorium", "Șterge jumătate de {{Heart}} Inimă și oferă un cheag#Cheagul copiază lacrimile lui Isaac#Fiecare tip de inimă oferă un cheag cu viață, daune și efecte de lacrimi diferite"}, -- Sumptorium
	...
	[716] = {"716", "Sacul lui Keeper", "Oferă {{ColorGreen}}3{{CR}} {{Coin}} bănuți și {{ColorGreen}}1{{CR}} {{Key}} cheie#{{Shop}} Folosirea a 3 bănuți oferă:#↑ {{Speed}} {{ColorGreen}}+0.03{{CR}} Viteză#↑ {{Damage}} {{ColorGreen}}+0.5{{CR}} Daune#↑ {{Range}} {{ColorGreen}}+0.25{{CR}} Distanță"}, -- Keeper's Sack
	...
	[728] = {"728", "Gelu", "Un familiar demon iese din Isaac pe durata camerei#Demonul trage după cel mai apropiat inamic#Copiază lacrimele, statusurile și efectele lui Isac#{{Damage}} Lacrimele provoacă {{ColorGreen}}75%{{CR}} din daunele lui Isac"}, -- Gello
